...
void init_MidSN_Config() {
    ...
    stream.select[1].sensor = SENSOR_TEMPERATURE;
    stream.select[1].metric = FFIELD_VALUE;
    ...
    stream.select[1].sensor=SENSOR_NOTHING;
    stream.select[1].metric=FFIELD_LAST_AQUISITION_INTERVAL;

    stream.select[2].sensor=SENSOR_TEMPERATURE;
    stream.select[2].metric=FFIELD_LAST_AQUISITION_INTERVAL;

    stream.select[3].sensor=SENSOR_HUMIDITY;
    stream.select[3].metric=FFIELD_LAST_AQUISITION_INTERVAL;

    stream.select[4].sensor=SENSOR_BATTERY;
    stream.select[4].metric=FFIELD_LAST_AQUISITION_INTERVAL;

    stream.select[5].sensor=SENSOR_LIGHT;
    stream.select[5].metric=FFIELD_LAST_AQUISITION_INTERVAL;

    stream.select[6].sensor=SENSOR_LIGHT2;
    stream.select[6].metric=FFIELD_LAST_AQUISITION_INTERVAL;
     */




    stream.select[2].sensor = FFIELD_sensor_END;
    ev_addStreamAndEvent(&stream, 5000);
