...
public class MidSNMainTester3 {
    ...
    public static void main(String[] args) {
        ...
        MidSNMainTester3 node = new MidSNMainTester3();
        node.run();
    }
...
//        stream.setIpPort(4444);
    ...
    public MidSN_packet dataPacketTest() {
        ...
        packet.addIntToPacket(Definitions.CTRL_GP_DROP_STREAM);
        packet.addLongToPacket(System.currentTimeMillis());
        packet.addIntToPacket(123);
...
//        MidSN_packet pkt = dataPacketTest();
        ...
        try {
            ...
            Logger.getLogger(MidSNMainTester3.class.getName()).log(Level.SEVERE, null, ex);
        }
